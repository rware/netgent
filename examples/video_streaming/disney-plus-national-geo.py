...
try:
    with open("examples/video_streaming/disney-plus-national-geo/results/disney-plus-national-geo_result.json", "r") as f:
        result = json.load(f)
...
os.makedirs("examples/video_streaming/disney-plus-national-geo/results", exist_ok=True)
with open("examples/video_streaming/disney-plus-national-geo/results/disney-plus-national-geo_result.json", "w") as f:
