...
WORKFLOW_PATH = "/home/jkrauze1/netgent/prudentiaPrompts/twitch-watch.json"
...
prompt = [
        StatePrompt(
            ...
            actions=["[1] Go to the url 'https://www.twitch.tv/'", "[3] Wait 5 seconds for the page to load"]
        ),
        StatePrompt(
            name="On the Video Player",
            description="Play the video from the beginning for 600 seconds",
            triggers=["Only use URL as a Trigger"],
            actions=["[1] Click on a live video", "[2] Wait 600 seconds while the video plays"],
