...
WORKFLOW_PATH = "/home/jkrauze1/netgent/prudentiaPrompts/spotify.json"
...
prompt = [
        StatePrompt(
            ...
            actions=["[1] Hit control L to focus on the search bar", "[2] Go to the url 'https://open.spotify.com/album/6KpStFxRlr2jBWpZkyUeUO'", "[3] Wait 5 seconds for the page to load"]
        ),
        StatePrompt(
            name="On the Video Player",
            description="Play the video from the beginning for 30 seconds",
            triggers=["Only use URL as a Trigger"],
            actions=["[1] Click play", "[2] Wait 30 seconds while the music plays"],
