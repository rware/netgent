...
WORKFLOW_PATH = "/home/rware/prudentia/netgent/prudentiaPrompts/youtube-bunny-results.json"
...
prompt = [
        StatePrompt(
            ...
            actions=["[1] Press Ctrl+L (or Command+L on macOS) to focus the browser address bar", "[2] Type 'https://www.youtube.com/watch?v=YE7VzlLtp-4' into the address bar", "[3] Press Enter to navigate to the site", "[4] Wait 5 seconds for the page to load"]
        ),
        StatePrompt(
